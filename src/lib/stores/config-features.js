export const config = {
	mapTitle: 'overqualification', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-overqualification-8xre.vercel.app/', // The url provided when deploying the map on Vercel
